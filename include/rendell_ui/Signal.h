...
public:
    ...
    signal_connection_id_t connect(ClassType *object, MethodType method) {
        ...
        _connections.emplace_back(
            [object, method](Args... args) -> ReturnType { return (object->*method)(args...); });
    ...
    signal_connection_id_t connect(Signal<ReturnType, Args...> &signal) {
        _connections.emplace_back(
            [&signal](Args... args) -> ReturnType { return signal.emit(args...); });
...
private:
    ...
    signal_connection_id_t generateConnectionId() { return _connectionIdCounter++; }
