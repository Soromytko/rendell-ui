...
#define RENDELL_UI_DECLARE_WEAK_PTR(ClassName) typedef std::weak_ptr<ClassName> ClassName##WeakPtr;
...
#define RENDELL_UI_DECLARE_WIDGET(WidgetClassName)                                                 \
    ...
    WidgetClassName##SharedPtr create##WidgetClassName(                                            \
        RENDELL_UI_NAMESPACE::WidgetWeakPtr parent = {}, Args && ...args) {                        \
        return RENDELL_UI_NAMESPACE::createWidget<WidgetClassName>(parent, true,                   \
                                                                   std::forward<Args>(args)...);   \
    }                                                                                              \
                                                                                                   \
    template <typename... Args>                                                                    \
    WidgetClassName##SharedPtr createUnregistered##WidgetClassName(                                \
        RENDELL_UI_NAMESPACE::WidgetWeakPtr parent = {}, Args && ...args) {                        \
        return RENDELL_UI_NAMESPACE::createWidget<WidgetClassName>(parent, false,                  \
                                                                   std::forward<Args>(args)...);   \
    }
